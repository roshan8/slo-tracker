...
const tableColumns = (props) => [
    {
        title: 'SLO',
        key: 'slo_name',
        render: (o: ISLO) => <Link to="/" onClick={() => {props.setActiveSLO(o)}} style={{color: "#0f0f0f"}}>{o.slo_name}</Link>
    },
    {
        title: 'Target',
    ...
    },
    {
        ...
        key: 'View Incidents',
        render: (o: ISLO) => <Link to="/" onClick={() => {props.setActiveSLO(o)}}>View Incidents</Link>
    },
